                                        ...
                                        <div class="active tab-pane" id="settings">
                                            <form class="form-horizontal">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text"
                                                            value="<?php echo ucwords($t_users['fullname']) ?>"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <select id="country" name="country" class="form-control">
                                                            <option value="<?php echo $t_users['country'] ?>">
                                                                <?php echo $t_users['country'] ?></option>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <select name="nationality" id="nationality"
                                                            class="form-control">
                                                            <option
                                                                value="<?php echo ucfirst($t_users['nationality']) ?>">
                                                                <?php  echo ucfirst($t_users['nationality']) ?></option>
                                                ...
                                                <div class="form-group row">
                                                    <div class="offset-sm-2 col-sm-10">
                                                        <button type="button" id="eddbtn" class="btn btn-danger">Update
                                                            Profile</button>
                                                    </div>
                                                </div>
                                            </form>
