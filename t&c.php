            ...
            <div class="row g-4 justify-content-center">
                <div class="col-lg-12 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <p>Please read this End-User License Agreement carefully before clicking the &quot;I Agree&quot;
                        button, downloading or using Unistudents Match</p>
                    ...
                    <ul>
                        <li>
                            <p><strong>Agreement</strong> means this End-User License Agreement that forms the entire
                                agreement between You and the Company regarding the use of the Application.</p>
                        </li>
                        <li>
                        ...
                        <li>
                            <p><strong>Application Store</strong> means the digital distribution service operated and
                                developed by Apple Inc. (Apple App Store) or Google Inc. (Google Play Store) by which
                                the Application has been downloaded to your Device.</p>
                        </li>
                        <li>
                        ...
                        <li>
                            <p><strong>Family Sharing / Family Group</strong> permits You to share applications
                                downloaded through the Application Store with other family members by allowing them to
                                view and download each others' eligible Applications to their associated Devices.</p>
                        </li>
                        <li>
                    ...
                    <p>This Agreement is between You and the Company only and not with the Application Store. Therefore,
                        the Company is solely responsible for the Application and its content. Although the Application
                        Store is not a party to this Agreement, it has the right to enforce it against You as a third
                        party beneficiary relating to your use of the Application.</p>
                    <p>Since the Application can be accessed and used by other users via, for example, Family Sharing /
                    ...
                    <p>You may only use the Application on a Device that You own or control and as permitted by the
                        Application Store's terms and conditions.</p>
                    ...
                    <ul>
                        <li>License, sell, rent, lease, assign, distribute, transmit, host, outsource, disclose or
                            ...
                            third party.</li>
                        <li>Copy or use the Application for any purpose other than as permitted under the above section
                            'License'.</li>
                        <li>Modify, make derivative works of, disassemble, decrypt, reverse compile or reverse engineer
                            any part of the Application.</li>
                    ...
                    <p>The Company is not responsible for the entries, information or content of the Application's
                        users.
                        You expressly understand and agree that You are solely responsible for the Content and for all
                        activity that occurs under your account, whether done so by You or any third person using your
                        account.</p>
                    ...
                    <ul>
                        ...
                        <li>Defamatory, discriminatory, or mean-spirited content, including references or commentary
                            ...
                            groups.</li>
                        <li>Spam, machine – or - or randomly - – generated, constituting unauthorized or unsolicited
                    ...
                    <p>The Company reserves the right, but not the obligation, to, in its sole discretion, determine
                        ...
                        such objectionable Content.</p>
                    <p>As the Company cannot control all content posted by users and/or third parties on the
                    ...
                    <p>The Application, including without limitation all copyrights, patents, trademarks, trade secrets
                        and other intellectual property rights are, and shall remain, the sole and exclusive property of
                        the Company.</p>
                    <p>The Company shall not be obligated to indemnify or defend You with respect to any third party
                        ...
                        the Application or your use of it infringes any third party intellectual property rights.</p>
                    <h1>Your Suggestions</h1>
                    <p>Any feedback, comments, ideas, improvements or suggestions provided by You to the Company with
                        respect to the Application shall remain the sole and exclusive property of the Company.</p>
                    <p>The Company shall be free to use, copy, modify, publish, or redistribute the Suggestions for any
                        purpose and in any way without any credit or any compensation to You.</p>
                    <h1>Modifications to the Application</h1>
                    <p>The Company reserves the right to modify, suspend or discontinue, temporarily or permanently, the
                    ...
                    <p>The Company may from time to time provide enhancements or improvements to the
                        features/functionality of the Application, which may include patches, bug fixes, updates,
                        upgrades and other modifications.</p>
                    <p>Updates may modify or delete certain features and/or functionalities of the Application. You
                        agree that the Company has no obligation to (i) provide any Updates, or (ii) continue to provide
                        or enable any particular features and/or functionalities of the Application to You.</p>
                    <p>You further agree that all updates or any other modifications will be (i) deemed to constitute an
                        integral part of the Application, and (ii) subject to the terms and conditions of this
                        Agreement.</p>
                    <h2>Maintenance and Support</h2>
                    <p>The Company does not provide any maintenance or support for the download and use of the
                    ...
                    <p>The Company collects, stores, maintains, and shares information about You in accordance with Our
                        Privacy Policy: <a href="https://unistudentsmatch.com/privacy" rel="external nofollow noopener"
                            target="_blank">https://unistudentsmatch.com/privacy</a></p>
                    <p>By accepting this Agreement, You acknowledge that You hereby agree and consent to the terms and
                        conditions of Our Privacy Policy.</p>
                    ...
                    <p>Some jurisdictions do not allow the exclusion of certain types of warranties or limitations on
                        ...
                        Store, shall be solely responsible for such warranty.</p>
                    ...
                    <p>You expressly understand and agree that the Application Store, its subsidiaries and affiliates,
                    ...
                    <p>The Company does not make any warranties concerning the Application. To the extent You have any
                    ...
                    <ul>
                        <li>
                            <p>By email: <a href="mailto: info@unistudentsmatch.com" class="__cf_email__"
                                    data-cfemail="">[email&#160;protected]</a>
                            </p>
                        </li>
                        <li>
                            <p>By visiting this page on our website: <a href="https://unistudentsmatch.com/privacy"
                                    rel="external nofollow noopener"
                                    target="_blank">https://unistudentsmatch.com/privacy</a>
                            </p>
                        </li>
                    </ul>
                </div>
